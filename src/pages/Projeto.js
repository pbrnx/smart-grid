...
function Projeto() {
    return (
        <>
            ...
            <h2 className='h2Proj'>O que é?</h2>
            ...
            <ul className='lista'>
                <li>Baixo nível dos reservatórios de água nas hidrelétricas: O sistema elétrico brasileiro é altamente dependente da energia hidrelétrica, e a falta de chuvas em algumas regiões tem levado a um baixo nível dos reservatórios, reduzindo a capacidade de geração de energia elétrica.</li>
                <li>Aumento do consumo de energia elétrica: Com o crescimento da população e da economia do país, houve um aumento significativo do consumo de energia elétrica nos últimos anos, o que tem sobrecarregado o sistema elétrico.</li>
                <li>Falta de investimentos em novas fontes de energia: O Brasil tem um grande potencial para a geração de energia a partir de fontes renováveis, como solar, eólica e biomassa, mas os investimentos nesse setor têm sido insuficientes para suprir a demanda crescente de energia elétrica.</li>
            </ul>
            <Galeria />
        </>
    )
